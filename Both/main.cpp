...
sl::String outputPath("C:/Documentos 2/CLion/Cameras/Both/output/test.svo");
...
int main()
{
  ...
  //Wait for 2 seconds and let other threads to finishi before closing
...
bool initZed(sl::Camera &zedObject)
{
  ...
  rec_parameters.video_filename = outputPath;
